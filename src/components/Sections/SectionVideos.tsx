...
const SectionVideos: FC<SectionVideosProps> = ({
  ...
  return (
    <div className={`nc-SectionVideos ${className}`}>
      <Heading
        desc="Découvrez nos vidéos les plus chaudes. Visionnez plus et partagez plus de nouvelles sur n'importe quel sujet. Tout le monde est le bienvenu."
      >
        🎬 Quelques médias intéressants
      </Heading>
